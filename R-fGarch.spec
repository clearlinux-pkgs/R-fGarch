...
Version  : 3042.83.2
Release  : 29
URL      : https://cran.r-project.org/src/contrib/fGarch_3042.83.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fGarch_3042.83.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619367610
